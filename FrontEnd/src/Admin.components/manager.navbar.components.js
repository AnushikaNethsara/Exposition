...
function createPDF() {
  ...
  win.document.write('<title>Registration Report</title>');   // <title> FOR PDF HEADER.
  win.document.write(style);          // ADD STYLE INSIDE THE HEAD TAG.
  win.document.write('</head>');
  win.document.write('<body style="color:black;"> <h1 style="font-size:400%;">Exposition IUAC</h1> Report Generated by Admin Portal<br/><h3>Administrator Details</h3><b>Username: </b>' + name + '<br/><b>User ID: </b>' + userId + '<br/><b>Email : </b>' + emai + '<h3>Summary</h3>');
...
export default class Navbar extends Component {
  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-dark" style={{backgroundColor:"#F57C00"}}>
        <a
          className="navbar-brand"
          href="#"
        > <h1 style={{ color: "black" }}>Admin          | <b style={{ color: "white" }}>{localStorage.getItem("username")} </b>  </h1></a>
        <button
        ...
        >
          <ul className="navbar-nav">
            ...
            > <li className="nav-item active">
                <h4 id="dashboard" style={{ paddingLeft: "50px"  , color:"#FFD54F" }}><i class="zmdi zmdi-view-dashboard"></i> Dashboard    </h4> <span className="sr-only">(current)</span>
              </li></Link>
            <Link
              className="nav-link"
              to="/admin/roles"

            ><li className="nav-item active" style={{display:localStorage.getItem("role")==="admin"?"block":"none"}}>
                <h4 id="products" style={{ paddingLeft: "50px"  , color:"#FFD54F"}}>   <i class="zmdi zmdi-case"></i> Role Assignment     </h4> <span className="sr-only">(current)</span>
              </li></Link>
            <li className="nav-item">
              ...
              ><h4 id="purchases" style={{ paddingLeft: "50px"  , color:"#FFD54F" }}>  <i class="zmdi zmdi-graduation-cap"></i> Universities Management   </h4></Link>
            </li>
            <li className="nav-item">
              <a
                className="nav-link"
            ...
            <li style={{ paddingLeft: "10%" }} className="nav-item dropdown">
              ...
              >
                ...
                <Link
                  className="nav-link"
                  onClick={this.logout} to="/admin/login/" >
